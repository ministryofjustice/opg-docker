...
CHILD_CONTAINERS := golang rabbitmq wordpress elasticsearch elasticsearch-shared-data jenkins jenkins-slave kibana nginx-router fake-sqs wkhtmlpdf nginx-redirect casperjs backupninja mongodb
